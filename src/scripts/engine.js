...
async function  createCardImage(IdCard,fielsSide){
    ...
    if(fielsSide === playerSides.player1){
...
async function removeAllCardsImages(){
    ...
    let cards = document.querySelector("#computed-cards");
...
function init(){
    ...
    drawnCards(5, playerSides.player1)
    drawnCards(5, playerSides.computer)
